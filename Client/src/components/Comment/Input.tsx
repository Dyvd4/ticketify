...
function Input(props: InputProps) {
	const { variant, value, setValue, onCancel, onSubmit, avatar, ...restProps } = props;
	...
	return (
		<Flex data-testid="CommentInput" gap={2} {...restProps}>
			{variant !== "edit" && avatar && (
				<>
					<Avatar
				...
				{buttonsActive && (
					<>
						<Flex justifyContent={"flex-end"}>
							<ButtonGroup>
								<Button size={"sm"} onClick={handleOnCancel}>
									Cancel
								</Button>
								<Button
									size={"sm"}
