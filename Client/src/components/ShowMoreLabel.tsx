...
function ShowMoreLabel({
    ...
    return contentHasOverflow ? (
        <Box
            ...
            {...props}
            className="text-secondary my-1 cursor-pointer pl-1 text-sm hover:underline"
            onClick={() =>
                props.setContentNoOfLines(showMore ? 100000000000 : defaultContentNoOfLines)
            }
        >
