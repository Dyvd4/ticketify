import { Box, Button, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, useToast } from '@chakra-ui/react';
...
function AddPinnedTicketModal({ className, ...props }: AddPinnedTicketModalProps) {
    ...
    const ticketsToPinQuery = useQuery(["ticketsToPin"], () => fetchEntity({
