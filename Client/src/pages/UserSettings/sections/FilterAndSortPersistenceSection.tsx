...
function FilterAndSortPersistenceSection() {
    ...
    const filterAndSortPersistenceSettingsByLocalStorageAreChecked = currentUserSettings.allowFilterItemsByLocalStorage && currentUserSettings.allowSortItemsByLocalStorage
    const filterAndSortPersistenceSettingsByUrlAreChecked = currentUserSettings.allowFilterItemsByUrl && currentUserSettings.allowSortItemsByUrl;
    const someFilterAndSortPersistenceSettingsByLocalStorageAreChecked = [currentUserSettings.allowFilterItemsByLocalStorage, currentUserSettings.allowSortItemsByLocalStorage].some(setting => setting);
    const someFilterAndSortPersistenceSettingsByUrlAreChecked = [currentUserSettings.allowFilterItemsByUrl, currentUserSettings.allowSortItemsByUrl].some(setting => setting);
        ...
        <>
            ...
            <SettingsSwitch
                ...
                switchProps={{
                    ...
                    onChange: () => mutation.mutate({
                        allowSortItemsByLocalStorage: !filterAndSortPersistenceSettingsByLocalStorageAreChecked,
                        allowFilterItemsByLocalStorage: !filterAndSortPersistenceSettingsByLocalStorageAreChecked
                    }),
                    size: "md"
                }}
            />
            <SettingsSwitch
                ...
                switchProps={{
                    ...
                    onChange: () => mutation.mutate({ allowFilterItemsByLocalStorage: !currentUserSettings.allowFilterItemsByLocalStorage })
                }}
            />
            <SettingsSwitch
                disabled={someFilterAndSortPersistenceSettingsByUrlAreChecked}
                ...
                description={<>
                    <span>
                        This works the same way as mentioned in the
                    </span>
                    <b>&nbsp;
                        "Allow sort to be stored in- and applied by local storage"-setting,
                    </b>&nbsp;
                    <span>
                        but for sort."
                    </span>
                ...
                switchProps={{
                    ...
                    onChange: () => mutation.mutate({ allowSortItemsByLocalStorage: !currentUserSettings.allowSortItemsByLocalStorage })
                }}
            />
            ...
            <SettingsSwitch
                ...
                switchProps={{
                    ...
                    onChange: () => mutation.mutate({ allowFilterItemsByUrl: !currentUserSettings.allowFilterItemsByUrl })
                }}
            />
            <SettingsSwitch
                disabled={someFilterAndSortPersistenceSettingsByLocalStorageAreChecked}
                ...
                description={<>
                    ...
                    <b>&nbsp;
                        "Allow filter to be stored in- and applied by URL"-setting,
                    </b>&nbsp;
                    <span>
                        but for sort.
                    </span>
                ...
                switchProps={{
                    ...
                    onChange: () => mutation.mutate({ allowSortItemsByUrl: !currentUserSettings.allowSortItemsByUrl })
                }}
            />
        </>
    );
