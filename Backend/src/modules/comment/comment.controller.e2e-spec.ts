...
describe("CommentController", () => {
	...
	describe("GET /comments", () => {
		it("should sort it based on orderBy params", async () => {
			...
			const response = await request(app.getHttpServer()).get("/comments").query({
				orderBy: "newestFirst",
			});
			...
			expect(
				Date.UTC(createdAt.getFullYear(), createdAt.getMonth(), createdAt.getDay())
			).toBe(Date.UTC(newestDate.getFullYear(), newestDate.getMonth(), newestDate.getDay()));
		});
	});
